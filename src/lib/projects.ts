...
export const projects: Project[] = [
  {
    ...
    neighborhood: 'Anthem',
    date: '2024-01',
    services: ['artificial-turf', 'pavers', 'lighting', 'landscape-design'],
    description: 'Full backyard renovation including 1,200 sq ft of premium artificial turf, custom paver patio with seating wall, and complete landscape lighting system. This desert oasis transformation turned a bare dirt lot into a functional, beautiful outdoor living space perfect for entertaining.',
    images: {
      thumbnail: '/images/projects/placeholder-landscape-1.jpg',
      gallery: [
        '/images/projects/placeholder-landscape-1.jpg',
    ...
    testimonial: {
      quote: 'Desert Greenscapes completely transformed our backyard! The artificial turf looks incredibly natural and the kids love it. Steve and his team were professional and finished in just four days.',
